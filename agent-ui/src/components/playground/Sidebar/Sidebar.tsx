...
const SidebarHeader = () => (
  <div className="flex items-center gap-2">
    ...
    <span className="text-xs font-medium uppercase text-sidebar-foreground">Agent UI</span>
  </div>
)
...
const Sidebar = () => {
  ...
  return (
    <motion.aside
      className="relative flex h-screen shrink-0 grow-0 flex-col overflow-hidden px-2 py-3 font-dmmono bg-sidebar"
      initial={{ width: '16rem' }}
